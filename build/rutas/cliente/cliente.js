...
//cambiar contraseña
app.put('/clientes/changePass/:strEmail', function (req, res) {
    ...
    cliente_model_1.default.findOne({ strEmail: emailAdmin }).then(function (cliente) {
        ...
        cliente_model_1.default.findByIdAndUpdate(cliente._id, { strPassword: newPass }).then(function (passChanged) {
            if (!passChanged) {
                return res.json({
...
app.post('/clientes/login', function (req, res) {
    ...
    cliente_model_1.default.findOne({ strEmail: strEmail }).then(function (cliente) {
        ...
        bcrypt.compare(strPassword, cliente.strPassword).then(function (resp) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                strNombre = cliente.strNombre, strApellidos = cliente.strApellidos;
